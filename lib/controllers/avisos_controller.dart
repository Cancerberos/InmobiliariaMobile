...
class AvisosController extends GetxController {
  ...
  void fetchAvisos() async {
    try {
      isLoading(true);
      var avisos = await remoteServices.getAvisos();
      avisosList.value = avisos;
    } finally {
      isLoading(false);
    }
  }
